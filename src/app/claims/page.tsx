...
export default function ClaimsPage() {
    ...
    return (
        <section className="flex flex-col gap-20 justify-center h-screen p-20">
            <PriceDashboard />
        ...
        //                 {[
        //                     { label: "Total Claims", value: claimsData.length, color: "from-blue-600 to-blue-700" },
        //                     { label: "Pending", value: claimsData.filter(c => c.status === "pending").length, color: "from-amber-500 to-yellow-500" },
        //                     { label: "Approved", value: claimsData.filter(c => c.status === "approved").length, color: "from-emerald-500 to-green-500" },
        //                     { label: "Total Amount", value: `£${claimsData.reduce((sum, c) => sum + c.amount, 0).toLocaleString()}`, color: "from-blue-700 to-blue-800" }
        //                 ].map((stat, idx) => (
